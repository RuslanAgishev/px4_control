...
def convert_to_euler(pose_mat):
    yaw = math.atan2(pose_mat[1][0], pose_mat[0][0]) / math.pi * 180
    pitch = math.atan2(pose_mat[2][0], pose_mat[0][0]) / math.pi * 180
    roll = math.atan2(pose_mat[2][1], pose_mat[2][2]) / math.pi * 180
    x = pose_mat[0][3]
    y = pose_mat[1][3]
    z = pose_mat[2][3]
